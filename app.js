...
function setupPlayer() {
  ...
  audio.addEventListener("play", () => {
    ...
    // Same existing <audio> element, same analyser (if the Full
    // Player is open) — just make sure the AudioContext isn't left
    // suspended (some browsers auto-suspend it) so the visualizer
    // keeps reacting to the new/resumed audio.
...
function visualizerOnPlayerOpen() {
  ...
  if (graph && vizAudioCtx.state === "suspended") {
